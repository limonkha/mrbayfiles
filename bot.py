...
START_TEXT = """
__ I'ᴍ__ **MrBayFɪʟᴇsBᴏᴛ**  \n\n__I Cᴀɴ Uᴘʟᴏᴀᴅ Fɪʟᴇs Tᴇʟᴇɢʀᴀ Tᴏ AɴᴏɴFɪʟᴇs__\n\n__MᴀɪɴTᴀɪɴᴇᴅ Bʏ__ :** @mrbotslist**
"""
HELP_TEXT = """
**AɴᴏɴFɪʟᴇsBᴏᴛ Hᴇʟᴘ**\n\n__Sᴇɴᴅ ᴍᴇ ᴀɴʏ ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ ғɪʟᴇ, I'ʟʟ ᴜᴘʟᴏᴀᴅ ɪᴛ ᴛᴏ bayғɪʟᴇs.ᴄᴏᴍ ᴀɴᴅ ɢɪᴠᴇ ʏᴏᴜ ᴅɪʀᴇᴄᴛ ᴅᴏᴡɴʟᴏᴀᴅ ʟɪɴᴋ__\n\n__MᴀɪɴTᴀɪɴᴇᴅ Bʏ__ :** @mrbotslist**
"""
ABOUT_TEXT = """
- **Bot :** `MrBayFilesBot`
...
**",
    ...
    try:
        ...
        await m.edit("**Uᴘʟᴏᴀᴅɪɴɢ ᴛᴏ BayFIʟᴇs Sᴇʀᴠᴇʀ Pʟᴇᴀsᴇ Wᴀɪᴛ**")
        callapi = requests.post("https://api.bayfiles.com/upload", files=files)
        text = callapi.json()
        output = f"""
<u>**Fɪʟᴇ Uᴘʟᴏᴀᴅᴇᴅ Tᴏ BayFɪʟᴇs**</u>
...
bot.start()
print("BayFilesBot Is Started!,  if Have Any Problems contact @mrbotslist")
idle()
